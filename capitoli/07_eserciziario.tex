...
\begin{itemize}
    ...
    \begin{itemize}
        \item Centrato sul 20 ($x[2], x[3], x[4]$): $\{2, 20, 3\} \rightarrow \text{ordinato} \{2, 3, 20\} \rightarrow \text{Mediano} = 3$.
        \item Centrato sul primo 3 ($x[1], x[2], x[3]$): $\{3, 2, 20\} \rightarrow \text{ordinato} \{2, 3, 20\} \rightarrow \text{Mediano} = 3$.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Centrato sul primo 3: $\frac{3 + 2 + 20}{3} = \frac{25}{3} \approx 8.33$.
    \end{itemize}
