...
\begin{itemize}
    ...
    Nella realtà le classi non sono mai perfettamente separabili. Si introducono le \textbf{Variabili Slack} ($\xi$) per tollerare misclassificazioni, regolate dal parametro $C$ (\textit{Soft Margin}): un $C$ grande impone confini severi, abbassando gli errori ma alzando l'overfitting.
    ...
    \begin{figure}[h!]
        ...
        \begin{tikzpicture}[scale=1]
            ...
            % Iperpiani
            \draw[thick, black] (1,0) -- (4,4) node[right] {Iperpiano Ottimale};
            \draw[thick, gray, dashed] (0,0.5) -- (2.5,3.8);
            \draw[thick, gray, dashed] (2,-0.5) -- (5,3.5);

            % Margine
            \draw[<->, thick] (2.1, 2) -- (3.2, 1.2) node[midway, sloped, above] {Margine};
        \end{tikzpicture}
        \caption{Rappresentazione concettuale di una SVM lineare bidimensionale che massimizza il margine.}
    \end{figure}
