...
La semplice suddivisione in Train e Test (Holdout) può generare distorsioni dovute alla casualità dello split. Si adopera pertanto la \textbf{K-fold Cross Validation}: il dataset viene diviso in $K$ partizioni (fold); iterativamente, $K-1$ fold addestrano il modello e il rimanente funge da test, ripetendo $K$ volte. Le metriche finali sono la media delle singole iterazioni.
