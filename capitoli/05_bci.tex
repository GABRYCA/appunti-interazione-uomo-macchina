...
\begin{table}[h!]
    ...
    \begin{tabular}{|p{3cm}|p{2cm}|p{8cm}|}
        ...
        \hline
        \textbf{Alpha ($\alpha$)} & $8 - 13$ Hz & Veglia rilassata (occhi chiusi). Dominante nei lobi occipitali. \\
        \hline
        ...
        \hline
        \textbf{Beta ($\beta$)} & $14 - 30$ Hz & Veglia attiva, forte concentrazione, calcolo mentale. \\
        \hline
        \textbf{Gamma ($\gamma$)} & $> 30$ Hz & Elaborazione multisensoriale complessa, consolidamento memorie (spesso disturbata da artefatti muscolari). \\
        \hline
    \end{tabular}
