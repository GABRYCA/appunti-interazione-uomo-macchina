...
(function(){
  const Q=[
    ...
    {q:'Sensore con fmax = 12 kHz e SNR richiesto di almeno 40 dB: cosa serve?',o:['24 kHz, 7 bit e 168 kbps','12 kHz, 6 bit e 72 kbps','48 kHz, 4 bit e 192 kbps','24 kHz, 4 bit e 96 kbps'],a:0,w:'fs ≥ 2·12 = 24 kHz; 40 = 6,02·n + 1,76 dà n ≈ 6,35, quindi 7 bit; R = 24 000 × 7 = 168 kbps.'},
    {q:'ADC 0–5 V a 8 bit con ingresso 2,15 V: quale livello?',o:['55','110','182','256'],a:1,w:'Δ = 5/255 ≈ 19,6 mV; livello = round(2,15/0,0196) = 110. Il 55 ignora il fondoscala, il 182 vale per −5…+5 V.'},
    {q:'Cosa discretizza la quantizzazione (rispetto al campionamento)?',o:['Il tempo, come il campionamento','L\u2019ampiezza in livelli finiti (il campionamento discretizza il tempo)','La frequenza di rete a 50 Hz','Il numero di soggetti del dataset'],a:1,w:'Campionamento = tempo discreto; quantizzazione = ampiezza discreta in L = 2^b livelli.'},
    {q:'Da 8 a 16 bit, cosa succede al numero di livelli?',o:['Raddoppia','Aumenta di 8 volte','Aumenta di 256 volte (256 → 65 536)','Resta invariato'],a:2,w:'2^8 = 256 contro 2^16 = 65 536: rapporto 65 536/256 = 256.'}
  ];
